        ...
        <div class="cart-card" v-for="item in cartStore.cartItems" :key="item.id">
          ...
          <div class="cart-card__content">
            ...
            <div class="cart-card__options">
              ...
              <!-- HAPUS: Logo indicator untuk production - sembunyikan dari user -->
              <!-- Logika di backend tetap berjalan untuk validasi, tapi tidak ditampilkan ke user -->
            </div>
...
const proceedToCheckout = () => {
  ...
  try {
    ...
    // Store selected item IDs instead of full objects
    ...
    // Store the items in sessionStorage which has separate quota
...
/* Placeholder styles untuk elemen yang dihapus - tidak mengubah layout existing */
.logo-indicator {
  /* Style tetap ada tapi tidak digunakan - mencegah error CSS */
  display: none;
}

.logo-indicator.has-logo,
.logo-indicator.no-logo {
  /* Style tetap ada untuk backward compatibility */
  display: none;
}
</style>
