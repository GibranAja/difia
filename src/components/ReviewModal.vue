    ...
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-body">
        ...
        <div class="product-info">
          <img
            :src="order.customOptions?.productImage"
        ...
        <div class="rating-section">
          <p class="rating-label">
            ...
            <span v-if="!rating" class="validation-hint">(wajib)</span>
          </p>
        ...
        <!-- Review Text - Changed to optional -->
        <div class="review-section">
          ...
          <div class="review-length">
            {{ reviewText.trim().length }}/{{ maxReviewLength }} karakter
          </div>

          <!-- Suggestions - Keep as optional -->
          <div class="suggestions">
            <p class="suggestion-label">
              <i class="fas fa-lightbulb"></i> Pilih Saran Ulasan (Opsional):
            </p>
        ...
        <div class="image-upload-section">
          ...
          <div class="image-upload-container">
            ...
            <div class="image-preview-container" v-if="reviewImages.length > 0">
              <div v-for="(image, index) in reviewImages" :key="index" class="preview-card">
      ...
      <div class="modal-footer">
        <div class="submission-requirements">
          <div v-if="!isValid" class="requirements-list">
            <div class="requirement-item" :class="{ 'requirement-met': rating > 0 }">
...
//   if (rating.value === 0) return 'Silakan berikan rating bintang'
//   return ''
// })

// Modified to only require rating
...
const submitReview = async () => {
  ...
  try {
    ...
    const images = await Promise.all(reviewImages.value.map((img) => img.preview))
    ...
    if (result.success) {
      ...
      emit('close', true) // Pass true to indicate successful submission
    } else {
